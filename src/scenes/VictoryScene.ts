...
export class VictoryScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    this.add
      .text(480, 188, "Voce provou que, nesse mundo, a cor e tudo.", {
        fontFamily: "Trebuchet MS, Verdana, sans-serif",
        fontSize: "26px",
        color: "#f8fafc",
        align: "center"
    ...
    this.add
      .text(480, 246, `Pontuacao final: ${gameState.score}`, {
        fontFamily: "Trebuchet MS, Verdana, sans-serif",
        fontSize: "32px",
        color: "#45d483",
        stroke: "#05070d",
    ...
    addButton(this, 480, 408, "Creditos", () => this.scene.start("CreditsScene"));
